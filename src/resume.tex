...
\begin{description}
 ...
 \item 5+ Years of experience specializing in Java backend development. Significant hands on experience working as
 \item fullstack developer on
 \item software built with ReactJS, Spring boot, REST web services. Interested in constructing better problem solving method for
 \item complex tasks, and opportunity to learn and apply emerging technologies.
